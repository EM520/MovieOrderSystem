...
//a method parameter as Optional i.e. it binds a null value to a method
//parameter if the request parameter is not present. */
...
//@DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam("date")
//LocalDate date,
//@DateTimeFormat(pattern = "HH:mm:ss") @RequestParam("time")
//LocalTime time) {
//return "URL parameters - <br>"
//+ " date = " + date + " <br>"
//+ " time = " + time;
...
//@ResponseBody
//public String handler(@RequestParam(name = "code", defaultValue = "10") int
//code
//) {
//return "URL parameters - <br>"
//+ " code = " + code;
...
//@ResponseBody
//public String getMovive(@RequestParam("movieName") String movieName
//) {
//return "Movies info- <br>"
